...
public interface CsiDriverOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CsiDriverOptions {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.spec = this.jsiiGet("spec", imports.k8s.CsiDriverSpec.class);
         ...
         */
        private Jsii$Proxy(final imports.k8s.CsiDriverSpec spec, final imports.k8s.ObjectMeta metadata) {
        ...
        @Override
        public imports.k8s.CsiDriverSpec getSpec() {
            return this.spec;
        }
