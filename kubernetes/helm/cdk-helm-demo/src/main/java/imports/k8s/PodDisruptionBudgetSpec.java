 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.966Z")
...
public interface PodDisruptionBudgetSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodDisruptionBudgetSpec {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.maxUnavailable = this.jsiiGet("maxUnavailable", imports.k8s.IntOrString.class);
            this.minAvailable = this.jsiiGet("minAvailable", imports.k8s.IntOrString.class);
         ...
         */
        private Jsii$Proxy(final imports.k8s.IntOrString maxUnavailable, final imports.k8s.IntOrString minAvailable, final imports.k8s.LabelSelector selector) {
        ...
        @Override
        public imports.k8s.IntOrString getMaxUnavailable() {
            return this.maxUnavailable;
        }

        @Override
        public imports.k8s.IntOrString getMinAvailable() {
