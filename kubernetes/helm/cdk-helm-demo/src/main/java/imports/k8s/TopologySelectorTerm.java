 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:09.046Z")
...
public interface TopologySelectorTerm extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements TopologySelectorTerm {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.matchLabelExpressions = this.jsiiGet("matchLabelExpressions", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.TopologySelectorLabelRequirement.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final java.util.List<? extends imports.k8s.TopologySelectorLabelRequirement> matchLabelExpressions) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.matchLabelExpressions = (java.util.List<imports.k8s.TopologySelectorLabelRequirement>)matchLabelExpressions;
        }

        @Override
        public java.util.List<imports.k8s.TopologySelectorLabelRequirement> getMatchLabelExpressions() {
