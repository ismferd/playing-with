 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:09.033Z")
...
public interface ServiceSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ServiceSpec {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.ports = this.jsiiGet("ports", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.ServicePort.class)));
            ...
            this.sessionAffinityConfig = this.jsiiGet("sessionAffinityConfig", imports.k8s.SessionAffinityConfig.class);
        ...
        @Override
        public java.util.List<imports.k8s.ServicePort> getPorts() {
            return this.ports;
        }
        ...
        @Override
        public imports.k8s.SessionAffinityConfig getSessionAffinityConfig() {
