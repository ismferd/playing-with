 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:09.059Z")
...
public interface VolumeProjection extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements VolumeProjection {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.configMap = this.jsiiGet("configMap", imports.k8s.ConfigMapProjection.class);
            this.downwardApi = this.jsiiGet("downwardAPI", imports.k8s.DownwardApiProjection.class);
            this.secret = this.jsiiGet("secret", imports.k8s.SecretProjection.class);
            this.serviceAccountToken = this.jsiiGet("serviceAccountToken", imports.k8s.ServiceAccountTokenProjection.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final imports.k8s.ConfigMapProjection configMap, final imports.k8s.DownwardApiProjection downwardApi, final imports.k8s.SecretProjection secret, final imports.k8s.ServiceAccountTokenProjection serviceAccountToken) {
        ...
        @Override
        public imports.k8s.ConfigMapProjection getConfigMap() {
            return this.configMap;
        }

        @Override
        public imports.k8s.DownwardApiProjection getDownwardApi() {
            return this.downwardApi;
        }

        @Override
        public imports.k8s.SecretProjection getSecret() {
            return this.secret;
        }

        @Override
        public imports.k8s.ServiceAccountTokenProjection getServiceAccountToken() {
