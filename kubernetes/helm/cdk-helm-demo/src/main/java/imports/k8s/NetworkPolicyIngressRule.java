 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.940Z")
...
public interface NetworkPolicyIngressRule extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NetworkPolicyIngressRule {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.from = this.jsiiGet("from", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.NetworkPolicyPeer.class)));
            this.ports = this.jsiiGet("ports", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.NetworkPolicyPort.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final java.util.List<? extends imports.k8s.NetworkPolicyPeer> from, final java.util.List<? extends imports.k8s.NetworkPolicyPort> ports) {
        ...
        @Override
        public java.util.List<imports.k8s.NetworkPolicyPeer> getFrom() {
            return this.from;
        }

        @Override
        public java.util.List<imports.k8s.NetworkPolicyPort> getPorts() {
            return this.ports;
        }
