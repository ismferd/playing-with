 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.867Z")
...
public interface CsiPersistentVolumeSource extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CsiPersistentVolumeSource {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.controllerExpandSecretRef = this.jsiiGet("controllerExpandSecretRef", imports.k8s.SecretReference.class);
            this.controllerPublishSecretRef = this.jsiiGet("controllerPublishSecretRef", imports.k8s.SecretReference.class);
            this.fsType = this.jsiiGet("fsType", java.lang.String.class);
            this.nodePublishSecretRef = this.jsiiGet("nodePublishSecretRef", imports.k8s.SecretReference.class);
            this.nodeStageSecretRef = this.jsiiGet("nodeStageSecretRef", imports.k8s.SecretReference.class);
         ...
         */
        private Jsii$Proxy(final java.lang.String driver, final java.lang.String volumeHandle, final imports.k8s.SecretReference controllerExpandSecretRef, final imports.k8s.SecretReference controllerPublishSecretRef, final java.lang.String fsType, final imports.k8s.SecretReference nodePublishSecretRef, final imports.k8s.SecretReference nodeStageSecretRef, final java.lang.Boolean readOnly, final java.util.Map<java.lang.String, java.lang.String> volumeAttributes) {
        ...
        @Override
        public imports.k8s.SecretReference getControllerExpandSecretRef() {
            return this.controllerExpandSecretRef;
        }

        @Override
        public imports.k8s.SecretReference getControllerPublishSecretRef() {
        ...
        @Override
        public imports.k8s.SecretReference getNodePublishSecretRef() {
            return this.nodePublishSecretRef;
        }

        @Override
        public imports.k8s.SecretReference getNodeStageSecretRef() {
