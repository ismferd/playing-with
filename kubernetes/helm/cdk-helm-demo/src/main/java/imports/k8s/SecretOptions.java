...
public interface SecretOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecretOptions {
         ...
         */
        private Jsii$Proxy(final java.util.Map<java.lang.String, java.lang.String> data, final imports.k8s.ObjectMeta metadata, final java.util.Map<java.lang.String, java.lang.String> stringData, final java.lang.String type) {
