...
public interface CustomResourceSubresources extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CustomResourceSubresources {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.scale = this.jsiiGet("scale", imports.k8s.CustomResourceSubresourceScale.class);
         ...
         */
        private Jsii$Proxy(final imports.k8s.CustomResourceSubresourceScale scale, final java.lang.Object status) {
        ...
        @Override
        public imports.k8s.CustomResourceSubresourceScale getScale() {
            return this.scale;
        }
