 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.965Z")
...
public interface PodAntiAffinity extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodAntiAffinity {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.preferredDuringSchedulingIgnoredDuringExecution = this.jsiiGet("preferredDuringSchedulingIgnoredDuringExecution", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.WeightedPodAffinityTerm.class)));
            this.requiredDuringSchedulingIgnoredDuringExecution = this.jsiiGet("requiredDuringSchedulingIgnoredDuringExecution", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.PodAffinityTerm.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final java.util.List<? extends imports.k8s.WeightedPodAffinityTerm> preferredDuringSchedulingIgnoredDuringExecution, final java.util.List<? extends imports.k8s.PodAffinityTerm> requiredDuringSchedulingIgnoredDuringExecution) {
        ...
        @Override
        public java.util.List<imports.k8s.WeightedPodAffinityTerm> getPreferredDuringSchedulingIgnoredDuringExecution() {
            return this.preferredDuringSchedulingIgnoredDuringExecution;
        }

        @Override
        public java.util.List<imports.k8s.PodAffinityTerm> getRequiredDuringSchedulingIgnoredDuringExecution() {
