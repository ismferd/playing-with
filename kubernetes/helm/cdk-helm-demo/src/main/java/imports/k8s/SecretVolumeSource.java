 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:09.025Z")
...
public interface SecretVolumeSource extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecretVolumeSource {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.items = this.jsiiGet("items", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.KeyToPath.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final java.lang.Number defaultMode, final java.util.List<? extends imports.k8s.KeyToPath> items, final java.lang.Boolean optional, final java.lang.String secretName) {
        ...
        @Override
        public java.util.List<imports.k8s.KeyToPath> getItems() {
            return this.items;
        }
