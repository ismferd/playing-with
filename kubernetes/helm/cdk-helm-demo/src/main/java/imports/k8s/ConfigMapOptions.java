...
public interface ConfigMapOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ConfigMapOptions {
         ...
         */
        private Jsii$Proxy(final java.util.Map<java.lang.String, java.lang.String> binaryData, final java.util.Map<java.lang.String, java.lang.String> data, final imports.k8s.ObjectMeta metadata) {
