...
public interface ClusterRoleOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ClusterRoleOptions {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.aggregationRule = this.jsiiGet("aggregationRule", imports.k8s.AggregationRule.class);
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final imports.k8s.AggregationRule aggregationRule, final imports.k8s.ObjectMeta metadata, final java.util.List<? extends imports.k8s.PolicyRule> rules) {
        ...
        @Override
        public imports.k8s.AggregationRule getAggregationRule() {
