 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:09.028Z")
...
public interface SelfSubjectAccessReviewSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SelfSubjectAccessReviewSpec {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.nonResourceAttributes = this.jsiiGet("nonResourceAttributes", imports.k8s.NonResourceAttributes.class);
            this.resourceAttributes = this.jsiiGet("resourceAttributes", imports.k8s.ResourceAttributes.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final imports.k8s.NonResourceAttributes nonResourceAttributes, final imports.k8s.ResourceAttributes resourceAttributes) {
        ...
        @Override
        public imports.k8s.NonResourceAttributes getNonResourceAttributes() {
            return this.nonResourceAttributes;
        }

        @Override
        public imports.k8s.ResourceAttributes getResourceAttributes() {
