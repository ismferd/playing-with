 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.882Z")
...
public interface DeleteOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DeleteOptions {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.kind = this.jsiiGet("kind", imports.k8s.IoK8SApimachineryPkgApisMetaV1DeleteOptionsKind.class);
            this.orphanDependents = this.jsiiGet("orphanDependents", java.lang.Boolean.class);
            this.preconditions = this.jsiiGet("preconditions", imports.k8s.Preconditions.class);
         ...
         */
        private Jsii$Proxy(final java.lang.String apiVersion, final java.util.List<java.lang.String> dryRun, final java.lang.Number gracePeriodSeconds, final imports.k8s.IoK8SApimachineryPkgApisMetaV1DeleteOptionsKind kind, final java.lang.Boolean orphanDependents, final imports.k8s.Preconditions preconditions, final java.lang.String propagationPolicy) {
        ...
        @Override
        public imports.k8s.IoK8SApimachineryPkgApisMetaV1DeleteOptionsKind getKind() {
            return this.kind;
        }
        ...
        @Override
        public imports.k8s.Preconditions getPreconditions() {
