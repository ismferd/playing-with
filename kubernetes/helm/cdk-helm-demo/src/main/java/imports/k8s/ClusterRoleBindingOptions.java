 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.842Z")
...
public interface ClusterRoleBindingOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ClusterRoleBindingOptions {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.roleRef = this.jsiiGet("roleRef", imports.k8s.RoleRef.class);
            this.metadata = this.jsiiGet("metadata", imports.k8s.ObjectMeta.class);
            this.subjects = this.jsiiGet("subjects", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.Subject.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final imports.k8s.RoleRef roleRef, final imports.k8s.ObjectMeta metadata, final java.util.List<? extends imports.k8s.Subject> subjects) {
        ...
        @Override
        public imports.k8s.RoleRef getRoleRef() {
            return this.roleRef;
        }
        ...
        @Override
        public java.util.List<imports.k8s.Subject> getSubjects() {
