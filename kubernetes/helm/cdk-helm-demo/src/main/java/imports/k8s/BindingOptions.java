...
public interface BindingOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements BindingOptions {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.target = this.jsiiGet("target", imports.k8s.ObjectReference.class);
         ...
         */
        private Jsii$Proxy(final imports.k8s.ObjectReference target, final imports.k8s.ObjectMeta metadata) {
        ...
        @Override
        public imports.k8s.ObjectReference getTarget() {
            return this.target;
        }
