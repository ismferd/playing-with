...
public interface DeploymentStrategy extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DeploymentStrategy {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.rollingUpdate = this.jsiiGet("rollingUpdate", imports.k8s.RollingUpdateDeployment.class);
         ...
         */
        private Jsii$Proxy(final imports.k8s.RollingUpdateDeployment rollingUpdate, final java.lang.String type) {
        ...
        @Override
        public imports.k8s.RollingUpdateDeployment getRollingUpdate() {
