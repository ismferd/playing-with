...
public interface ControllerRevisionOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ControllerRevisionOptions {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.data = this.jsiiGet("data", imports.k8s.RawExtension.class);
         ...
         */
        private Jsii$Proxy(final java.lang.Number revision, final imports.k8s.RawExtension data, final imports.k8s.ObjectMeta metadata) {
        ...
        @Override
        public imports.k8s.RawExtension getData() {
            return this.data;
        }
