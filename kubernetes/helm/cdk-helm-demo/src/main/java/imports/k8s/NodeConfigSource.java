...
public interface NodeConfigSource extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NodeConfigSource {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.configMap = this.jsiiGet("configMap", imports.k8s.ConfigMapNodeConfigSource.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final imports.k8s.ConfigMapNodeConfigSource configMap) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.configMap = configMap;
        }

        @Override
        public imports.k8s.ConfigMapNodeConfigSource getConfigMap() {
