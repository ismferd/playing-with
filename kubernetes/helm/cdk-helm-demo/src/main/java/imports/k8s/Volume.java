...
public interface Volume extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements Volume {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.awsElasticBlockStore = this.jsiiGet("awsElasticBlockStore", imports.k8s.AwsElasticBlockStoreVolumeSource.class);
            this.azureDisk = this.jsiiGet("azureDisk", imports.k8s.AzureDiskVolumeSource.class);
            this.azureFile = this.jsiiGet("azureFile", imports.k8s.AzureFileVolumeSource.class);
            this.cephfs = this.jsiiGet("cephfs", imports.k8s.CephFsVolumeSource.class);
            this.cinder = this.jsiiGet("cinder", imports.k8s.CinderVolumeSource.class);
            this.configMap = this.jsiiGet("configMap", imports.k8s.ConfigMapVolumeSource.class);
            this.csi = this.jsiiGet("csi", imports.k8s.CsiVolumeSource.class);
            this.downwardApi = this.jsiiGet("downwardAPI", imports.k8s.DownwardApiVolumeSource.class);
            this.emptyDir = this.jsiiGet("emptyDir", imports.k8s.EmptyDirVolumeSource.class);
            this.fc = this.jsiiGet("fc", imports.k8s.FcVolumeSource.class);
            this.flexVolume = this.jsiiGet("flexVolume", imports.k8s.FlexVolumeSource.class);
            this.flocker = this.jsiiGet("flocker", imports.k8s.FlockerVolumeSource.class);
            this.gcePersistentDisk = this.jsiiGet("gcePersistentDisk", imports.k8s.GcePersistentDiskVolumeSource.class);
            this.gitRepo = this.jsiiGet("gitRepo", imports.k8s.GitRepoVolumeSource.class);
            this.glusterfs = this.jsiiGet("glusterfs", imports.k8s.GlusterfsVolumeSource.class);
            this.hostPath = this.jsiiGet("hostPath", imports.k8s.HostPathVolumeSource.class);
            this.iscsi = this.jsiiGet("iscsi", imports.k8s.IscsiVolumeSource.class);
            this.nfs = this.jsiiGet("nfs", imports.k8s.NfsVolumeSource.class);
            this.persistentVolumeClaim = this.jsiiGet("persistentVolumeClaim", imports.k8s.PersistentVolumeClaimVolumeSource.class);
            this.photonPersistentDisk = this.jsiiGet("photonPersistentDisk", imports.k8s.PhotonPersistentDiskVolumeSource.class);
            this.portworxVolume = this.jsiiGet("portworxVolume", imports.k8s.PortworxVolumeSource.class);
            this.projected = this.jsiiGet("projected", imports.k8s.ProjectedVolumeSource.class);
            this.quobyte = this.jsiiGet("quobyte", imports.k8s.QuobyteVolumeSource.class);
            this.rbd = this.jsiiGet("rbd", imports.k8s.RbdVolumeSource.class);
            this.scaleIo = this.jsiiGet("scaleIO", imports.k8s.ScaleIoVolumeSource.class);
            this.secret = this.jsiiGet("secret", imports.k8s.SecretVolumeSource.class);
            this.storageos = this.jsiiGet("storageos", imports.k8s.StorageOsVolumeSource.class);
            this.vsphereVolume = this.jsiiGet("vsphereVolume", imports.k8s.VsphereVirtualDiskVolumeSource.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final java.lang.String name, final imports.k8s.AwsElasticBlockStoreVolumeSource awsElasticBlockStore, final imports.k8s.AzureDiskVolumeSource azureDisk, final imports.k8s.AzureFileVolumeSource azureFile, final imports.k8s.CephFsVolumeSource cephfs, final imports.k8s.CinderVolumeSource cinder, final imports.k8s.ConfigMapVolumeSource configMap, final imports.k8s.CsiVolumeSource csi, final imports.k8s.DownwardApiVolumeSource downwardApi, final imports.k8s.EmptyDirVolumeSource emptyDir, final imports.k8s.FcVolumeSource fc, final imports.k8s.FlexVolumeSource flexVolume, final imports.k8s.FlockerVolumeSource flocker, final imports.k8s.GcePersistentDiskVolumeSource gcePersistentDisk, final imports.k8s.GitRepoVolumeSource gitRepo, final imports.k8s.GlusterfsVolumeSource glusterfs, final imports.k8s.HostPathVolumeSource hostPath, final imports.k8s.IscsiVolumeSource iscsi, final imports.k8s.NfsVolumeSource nfs, final imports.k8s.PersistentVolumeClaimVolumeSource persistentVolumeClaim, final imports.k8s.PhotonPersistentDiskVolumeSource photonPersistentDisk, final imports.k8s.PortworxVolumeSource portworxVolume, final imports.k8s.ProjectedVolumeSource projected, final imports.k8s.QuobyteVolumeSource quobyte, final imports.k8s.RbdVolumeSource rbd, final imports.k8s.ScaleIoVolumeSource scaleIo, final imports.k8s.SecretVolumeSource secret, final imports.k8s.StorageOsVolumeSource storageos, final imports.k8s.VsphereVirtualDiskVolumeSource vsphereVolume) {
        ...
        @Override
        public imports.k8s.AwsElasticBlockStoreVolumeSource getAwsElasticBlockStore() {
            return this.awsElasticBlockStore;
        }

        @Override
        public imports.k8s.AzureDiskVolumeSource getAzureDisk() {
            return this.azureDisk;
        }

        @Override
        public imports.k8s.AzureFileVolumeSource getAzureFile() {
            return this.azureFile;
        }

        @Override
        public imports.k8s.CephFsVolumeSource getCephfs() {
            return this.cephfs;
        }

        @Override
        public imports.k8s.CinderVolumeSource getCinder() {
            return this.cinder;
        }

        @Override
        public imports.k8s.ConfigMapVolumeSource getConfigMap() {
            return this.configMap;
        }

        @Override
        public imports.k8s.CsiVolumeSource getCsi() {
            return this.csi;
        }

        @Override
        public imports.k8s.DownwardApiVolumeSource getDownwardApi() {
            return this.downwardApi;
        }

        @Override
        public imports.k8s.EmptyDirVolumeSource getEmptyDir() {
            return this.emptyDir;
        }

        @Override
        public imports.k8s.FcVolumeSource getFc() {
            return this.fc;
        }

        @Override
        public imports.k8s.FlexVolumeSource getFlexVolume() {
            return this.flexVolume;
        }

        @Override
        public imports.k8s.FlockerVolumeSource getFlocker() {
            return this.flocker;
        }

        @Override
        public imports.k8s.GcePersistentDiskVolumeSource getGcePersistentDisk() {
            return this.gcePersistentDisk;
        }

        @Override
        public imports.k8s.GitRepoVolumeSource getGitRepo() {
            return this.gitRepo;
        }

        @Override
        public imports.k8s.GlusterfsVolumeSource getGlusterfs() {
            return this.glusterfs;
        }

        @Override
        public imports.k8s.HostPathVolumeSource getHostPath() {
            return this.hostPath;
        }

        @Override
        public imports.k8s.IscsiVolumeSource getIscsi() {
            return this.iscsi;
        }

        @Override
        public imports.k8s.NfsVolumeSource getNfs() {
            return this.nfs;
        }

        @Override
        public imports.k8s.PersistentVolumeClaimVolumeSource getPersistentVolumeClaim() {
            return this.persistentVolumeClaim;
        }

        @Override
        public imports.k8s.PhotonPersistentDiskVolumeSource getPhotonPersistentDisk() {
            return this.photonPersistentDisk;
        }

        @Override
        public imports.k8s.PortworxVolumeSource getPortworxVolume() {
            return this.portworxVolume;
        }

        @Override
        public imports.k8s.ProjectedVolumeSource getProjected() {
            return this.projected;
        }

        @Override
        public imports.k8s.QuobyteVolumeSource getQuobyte() {
            return this.quobyte;
        }

        @Override
        public imports.k8s.RbdVolumeSource getRbd() {
            return this.rbd;
        }

        @Override
        public imports.k8s.ScaleIoVolumeSource getScaleIo() {
            return this.scaleIo;
        }

        @Override
        public imports.k8s.SecretVolumeSource getSecret() {
            return this.secret;
        }

        @Override
        public imports.k8s.StorageOsVolumeSource getStorageos() {
            return this.storageos;
        }

        @Override
        public imports.k8s.VsphereVirtualDiskVolumeSource getVsphereVolume() {
