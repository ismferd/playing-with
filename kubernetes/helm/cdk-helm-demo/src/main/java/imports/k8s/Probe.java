...
public interface Probe extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements Probe {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = this.jsiiGet("exec", imports.k8s.ExecAction.class);
            this.failureThreshold = this.jsiiGet("failureThreshold", java.lang.Number.class);
            this.httpGet = this.jsiiGet("httpGet", imports.k8s.HttpGetAction.class);
            ...
            this.tcpSocket = this.jsiiGet("tcpSocket", imports.k8s.TcpSocketAction.class);
         ...
         */
        private Jsii$Proxy(final imports.k8s.ExecAction exec, final java.lang.Number failureThreshold, final imports.k8s.HttpGetAction httpGet, final java.lang.Number initialDelaySeconds, final java.lang.Number periodSeconds, final java.lang.Number successThreshold, final imports.k8s.TcpSocketAction tcpSocket, final java.lang.Number timeoutSeconds) {
        ...
        @Override
        public imports.k8s.ExecAction getExec() {
            return this.exec;
        }
        ...
        @Override
        public imports.k8s.HttpGetAction getHttpGet() {
            return this.httpGet;
        }
        ...
        @Override
        public imports.k8s.TcpSocketAction getTcpSocket() {
