 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.942Z")
...
public interface NetworkPolicyPeer extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NetworkPolicyPeer {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.ipBlock = this.jsiiGet("ipBlock", imports.k8s.IpBlock.class);
         ...
         */
        private Jsii$Proxy(final imports.k8s.IpBlock ipBlock, final imports.k8s.LabelSelector namespaceSelector, final imports.k8s.LabelSelector podSelector) {
        ...
        @Override
        public imports.k8s.IpBlock getIpBlock() {
            return this.ipBlock;
        }
