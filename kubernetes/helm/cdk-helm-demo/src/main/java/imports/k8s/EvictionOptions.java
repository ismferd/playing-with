 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.896Z")
...
public interface EvictionOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements EvictionOptions {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.deleteOptions = this.jsiiGet("deleteOptions", imports.k8s.DeleteOptions.class);
         ...
         */
        private Jsii$Proxy(final imports.k8s.DeleteOptions deleteOptions, final imports.k8s.ObjectMeta metadata) {
        ...
        @Override
        public imports.k8s.DeleteOptions getDeleteOptions() {
