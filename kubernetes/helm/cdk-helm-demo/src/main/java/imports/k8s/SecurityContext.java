 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:09.026Z")
...
public interface SecurityContext extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecurityContext {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.capabilities = this.jsiiGet("capabilities", imports.k8s.Capabilities.class);
            ...
            this.seLinuxOptions = this.jsiiGet("seLinuxOptions", imports.k8s.SeLinuxOptions.class);
            this.windowsOptions = this.jsiiGet("windowsOptions", imports.k8s.WindowsSecurityContextOptions.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final java.lang.Boolean allowPrivilegeEscalation, final imports.k8s.Capabilities capabilities, final java.lang.Boolean privileged, final java.lang.String procMount, final java.lang.Boolean readOnlyRootFilesystem, final java.lang.Number runAsGroup, final java.lang.Boolean runAsNonRoot, final java.lang.Number runAsUser, final imports.k8s.SeLinuxOptions seLinuxOptions, final imports.k8s.WindowsSecurityContextOptions windowsOptions) {
        ...
        @Override
        public imports.k8s.Capabilities getCapabilities() {
        ...
        @Override
        public imports.k8s.SeLinuxOptions getSeLinuxOptions() {
            return this.seLinuxOptions;
        }

        @Override
        public imports.k8s.WindowsSecurityContextOptions getWindowsOptions() {
