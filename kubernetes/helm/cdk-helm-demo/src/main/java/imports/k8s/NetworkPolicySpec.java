...
public interface NetworkPolicySpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NetworkPolicySpec {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.podSelector = this.jsiiGet("podSelector", imports.k8s.LabelSelector.class);
            this.egress = this.jsiiGet("egress", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.NetworkPolicyEgressRule.class)));
            this.ingress = this.jsiiGet("ingress", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.NetworkPolicyIngressRule.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final imports.k8s.LabelSelector podSelector, final java.util.List<? extends imports.k8s.NetworkPolicyEgressRule> egress, final java.util.List<? extends imports.k8s.NetworkPolicyIngressRule> ingress, final java.util.List<java.lang.String> policyTypes) {
        ...
        @Override
        public imports.k8s.LabelSelector getPodSelector() {
            return this.podSelector;
        }

        @Override
        public java.util.List<imports.k8s.NetworkPolicyEgressRule> getEgress() {
            return this.egress;
        }

        @Override
        public java.util.List<imports.k8s.NetworkPolicyIngressRule> getIngress() {
            return this.ingress;
        }
