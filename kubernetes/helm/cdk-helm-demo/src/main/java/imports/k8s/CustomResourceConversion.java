 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.873Z")
...
public interface CustomResourceConversion extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CustomResourceConversion {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.webhookClientConfig = this.jsiiGet("webhookClientConfig", imports.k8s.WebhookClientConfig.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final java.lang.String strategy, final java.util.List<java.lang.String> conversionReviewVersions, final imports.k8s.WebhookClientConfig webhookClientConfig) {
        ...
        @Override
        public imports.k8s.WebhookClientConfig getWebhookClientConfig() {
