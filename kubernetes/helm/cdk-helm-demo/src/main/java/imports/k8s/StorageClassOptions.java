 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:09.039Z")
...
public interface StorageClassOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StorageClassOptions {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.allowedTopologies = this.jsiiGet("allowedTopologies", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.TopologySelectorTerm.class)));
        ...
        @Override
        public java.util.List<imports.k8s.TopologySelectorTerm> getAllowedTopologies() {
