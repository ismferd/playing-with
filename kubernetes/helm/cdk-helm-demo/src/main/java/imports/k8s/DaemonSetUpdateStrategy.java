 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.881Z")
...
public interface DaemonSetUpdateStrategy extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonSetUpdateStrategy {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.rollingUpdate = this.jsiiGet("rollingUpdate", imports.k8s.RollingUpdateDaemonSet.class);
         ...
         */
        private Jsii$Proxy(final imports.k8s.RollingUpdateDaemonSet rollingUpdate, final java.lang.String type) {
        ...
        @Override
        public imports.k8s.RollingUpdateDaemonSet getRollingUpdate() {
