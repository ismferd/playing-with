...
public interface NetworkPolicyEgressRule extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NetworkPolicyEgressRule {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.to = this.jsiiGet("to", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.NetworkPolicyPeer.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final java.util.List<? extends imports.k8s.NetworkPolicyPort> ports, final java.util.List<? extends imports.k8s.NetworkPolicyPeer> to) {
        ...
        @Override
        public java.util.List<imports.k8s.NetworkPolicyPeer> getTo() {
            return this.to;
        }
