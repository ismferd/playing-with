...
public interface ServiceAccountOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ServiceAccountOptions {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.secrets = this.jsiiGet("secrets", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.ObjectReference.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final java.lang.Boolean automountServiceAccountToken, final java.util.List<? extends imports.k8s.LocalObjectReference> imagePullSecrets, final imports.k8s.ObjectMeta metadata, final java.util.List<? extends imports.k8s.ObjectReference> secrets) {
        ...
        @Override
        public java.util.List<imports.k8s.ObjectReference> getSecrets() {
            return this.secrets;
        }
