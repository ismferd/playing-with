...
public interface CsiNodeSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CsiNodeSpec {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.drivers = this.jsiiGet("drivers", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.CsiNodeDriver.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final java.util.List<? extends imports.k8s.CsiNodeDriver> drivers) {
        ...
        @Override
        public java.util.List<imports.k8s.CsiNodeDriver> getDrivers() {
            return this.drivers;
        }
