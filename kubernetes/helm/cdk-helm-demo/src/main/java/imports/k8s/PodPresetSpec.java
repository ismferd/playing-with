 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.970Z")
...
public interface PodPresetSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodPresetSpec {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.selector = this.jsiiGet("selector", imports.k8s.LabelSelector.class);
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final java.util.List<? extends imports.k8s.EnvVar> env, final java.util.List<? extends imports.k8s.EnvFromSource> envFrom, final imports.k8s.LabelSelector selector, final java.util.List<? extends imports.k8s.VolumeMount> volumeMounts, final java.util.List<? extends imports.k8s.Volume> volumes) {
        ...
        @Override
        public imports.k8s.LabelSelector getSelector() {
