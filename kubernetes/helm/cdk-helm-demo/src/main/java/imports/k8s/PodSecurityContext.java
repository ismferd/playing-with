...
public interface PodSecurityContext extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSecurityContext {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.sysctls = this.jsiiGet("sysctls", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.Sysctl.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final java.lang.Number fsGroup, final java.lang.Number runAsGroup, final java.lang.Boolean runAsNonRoot, final java.lang.Number runAsUser, final imports.k8s.SeLinuxOptions seLinuxOptions, final java.util.List<? extends java.lang.Number> supplementalGroups, final java.util.List<? extends imports.k8s.Sysctl> sysctls, final imports.k8s.WindowsSecurityContextOptions windowsOptions) {
        ...
        @Override
        public java.util.List<imports.k8s.Sysctl> getSysctls() {
            return this.sysctls;
        }
