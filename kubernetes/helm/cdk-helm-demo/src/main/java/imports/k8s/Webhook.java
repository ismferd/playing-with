 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:09.060Z")
...
public interface Webhook extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements Webhook {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.throttle = this.jsiiGet("throttle", imports.k8s.WebhookThrottleConfig.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final imports.k8s.WebhookClientConfig clientConfig, final imports.k8s.WebhookThrottleConfig throttle) {
        ...
        @Override
        public imports.k8s.WebhookThrottleConfig getThrottle() {
