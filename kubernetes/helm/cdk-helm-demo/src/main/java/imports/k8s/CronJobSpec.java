 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.862Z")
...
public interface CronJobSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CronJobSpec {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.jobTemplate = this.jsiiGet("jobTemplate", imports.k8s.JobTemplateSpec.class);
        ...
        @Override
        public imports.k8s.JobTemplateSpec getJobTemplate() {
