 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.974Z")
...
public interface PodSecurityPolicySpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSecurityPolicySpec {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.fsGroup = this.jsiiGet("fsGroup", imports.k8s.FsGroupStrategyOptions.class);
            this.runAsUser = this.jsiiGet("runAsUser", imports.k8s.RunAsUserStrategyOptions.class);
            this.seLinux = this.jsiiGet("seLinux", imports.k8s.SeLinuxStrategyOptions.class);
            this.supplementalGroups = this.jsiiGet("supplementalGroups", imports.k8s.SupplementalGroupsStrategyOptions.class);
            ...
            this.allowedCsiDrivers = this.jsiiGet("allowedCSIDrivers", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.AllowedCsiDriver.class)));
            this.allowedFlexVolumes = this.jsiiGet("allowedFlexVolumes", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.AllowedFlexVolume.class)));
            this.allowedHostPaths = this.jsiiGet("allowedHostPaths", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.AllowedHostPath.class)));
            ...
            this.hostPorts = this.jsiiGet("hostPorts", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.HostPortRange.class)));
            ...
            this.runAsGroup = this.jsiiGet("runAsGroup", imports.k8s.RunAsGroupStrategyOptions.class);
            this.runtimeClass = this.jsiiGet("runtimeClass", imports.k8s.RuntimeClassStrategyOptions.class);
        ...
        @Override
        public imports.k8s.FsGroupStrategyOptions getFsGroup() {
            return this.fsGroup;
        }

        @Override
        public imports.k8s.RunAsUserStrategyOptions getRunAsUser() {
            return this.runAsUser;
        }

        @Override
        public imports.k8s.SeLinuxStrategyOptions getSeLinux() {
            return this.seLinux;
        }

        @Override
        public imports.k8s.SupplementalGroupsStrategyOptions getSupplementalGroups() {
        ...
        @Override
        public java.util.List<imports.k8s.AllowedCsiDriver> getAllowedCsiDrivers() {
            return this.allowedCsiDrivers;
        }

        @Override
        public java.util.List<imports.k8s.AllowedFlexVolume> getAllowedFlexVolumes() {
            return this.allowedFlexVolumes;
        }

        @Override
        public java.util.List<imports.k8s.AllowedHostPath> getAllowedHostPaths() {
        ...
        @Override
        public java.util.List<imports.k8s.HostPortRange> getHostPorts() {
        ...
        @Override
        public imports.k8s.RunAsGroupStrategyOptions getRunAsGroup() {
            return this.runAsGroup;
        }

        @Override
        public imports.k8s.RuntimeClassStrategyOptions getRuntimeClass() {
