...
public interface CustomResourceDefinitionSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CustomResourceDefinitionSpec {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.names = this.jsiiGet("names", imports.k8s.CustomResourceDefinitionNames.class);
            this.scope = this.jsiiGet("scope", java.lang.String.class);
            this.additionalPrinterColumns = this.jsiiGet("additionalPrinterColumns", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.CustomResourceColumnDefinition.class)));
            this.conversion = this.jsiiGet("conversion", imports.k8s.CustomResourceConversion.class);
            this.preserveUnknownFields = this.jsiiGet("preserveUnknownFields", java.lang.Boolean.class);
            this.subresources = this.jsiiGet("subresources", imports.k8s.CustomResourceSubresources.class);
            this.validation = this.jsiiGet("validation", imports.k8s.CustomResourceValidation.class);
            this.version = this.jsiiGet("version", java.lang.String.class);
            this.versions = this.jsiiGet("versions", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.CustomResourceDefinitionVersion.class)));
        }
        ...
        @Override
        public imports.k8s.CustomResourceDefinitionNames getNames() {
            return this.names;
        }
        ...
        @Override
        public java.util.List<imports.k8s.CustomResourceColumnDefinition> getAdditionalPrinterColumns() {
            return this.additionalPrinterColumns;
        }

        @Override
        public imports.k8s.CustomResourceConversion getConversion() {
        ...
        @Override
        public imports.k8s.CustomResourceSubresources getSubresources() {
            return this.subresources;
        }

        @Override
        public imports.k8s.CustomResourceValidation getValidation() {
        ...
        @Override
        public java.util.List<imports.k8s.CustomResourceDefinitionVersion> getVersions() {
