...
public interface PodPresetOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodPresetOptions {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.spec = this.jsiiGet("spec", imports.k8s.PodPresetSpec.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final imports.k8s.ObjectMeta metadata, final imports.k8s.PodPresetSpec spec) {
        ...
        @Override
        public imports.k8s.PodPresetSpec getSpec() {
            return this.spec;
        }
