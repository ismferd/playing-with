 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.991Z")
...
public interface PreferredSchedulingTerm extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PreferredSchedulingTerm {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.preference = this.jsiiGet("preference", imports.k8s.NodeSelectorTerm.class);
         ...
         */
        private Jsii$Proxy(final imports.k8s.NodeSelectorTerm preference, final java.lang.Number weight) {
        ...
        @Override
        public imports.k8s.NodeSelectorTerm getPreference() {
