...
public interface ProjectedVolumeSource extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ProjectedVolumeSource {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.sources = this.jsiiGet("sources", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.VolumeProjection.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final java.util.List<? extends imports.k8s.VolumeProjection> sources, final java.lang.Number defaultMode) {
        ...
        @Override
        public java.util.List<imports.k8s.VolumeProjection> getSources() {
            return this.sources;
        }
