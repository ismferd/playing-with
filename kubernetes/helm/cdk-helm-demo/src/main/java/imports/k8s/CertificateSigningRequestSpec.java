 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.838Z")
...
public interface CertificateSigningRequestSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CertificateSigningRequestSpec {
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final java.lang.String request, final java.util.Map<java.lang.String, ? extends java.util.List<java.lang.String>> extra, final java.util.List<java.lang.String> groups, final java.lang.String uid, final java.util.List<java.lang.String> usages, final java.lang.String username) {
