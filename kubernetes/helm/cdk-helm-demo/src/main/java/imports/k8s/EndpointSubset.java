 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.888Z")
...
public interface EndpointSubset extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements EndpointSubset {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.addresses = this.jsiiGet("addresses", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.EndpointAddress.class)));
            this.notReadyAddresses = this.jsiiGet("notReadyAddresses", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.EndpointAddress.class)));
            this.ports = this.jsiiGet("ports", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.EndpointPort.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final java.util.List<? extends imports.k8s.EndpointAddress> addresses, final java.util.List<? extends imports.k8s.EndpointAddress> notReadyAddresses, final java.util.List<? extends imports.k8s.EndpointPort> ports) {
        ...
        @Override
        public java.util.List<imports.k8s.EndpointAddress> getAddresses() {
            return this.addresses;
        }

        @Override
        public java.util.List<imports.k8s.EndpointAddress> getNotReadyAddresses() {
            return this.notReadyAddresses;
        }

        @Override
        public java.util.List<imports.k8s.EndpointPort> getPorts() {
            return this.ports;
        }
