 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.894Z")
...
public interface EventOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements EventOptions {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.involvedObject = this.jsiiGet("involvedObject", imports.k8s.ObjectReference.class);
            ...
            this.related = this.jsiiGet("related", imports.k8s.ObjectReference.class);
            ...
            this.series = this.jsiiGet("series", imports.k8s.EventSeries.class);
            this.source = this.jsiiGet("source", imports.k8s.EventSource.class);
         ...
         */
        private Jsii$Proxy(final imports.k8s.ObjectReference involvedObject, final imports.k8s.ObjectMeta metadata, final java.lang.String action, final java.lang.Number count, final java.time.Instant eventTime, final java.time.Instant firstTimestamp, final java.time.Instant lastTimestamp, final java.lang.String message, final java.lang.String reason, final imports.k8s.ObjectReference related, final java.lang.String reportingComponent, final java.lang.String reportingInstance, final imports.k8s.EventSeries series, final imports.k8s.EventSource source, final java.lang.String type) {
        ...
        @Override
        public imports.k8s.ObjectReference getInvolvedObject() {
        ...
        @Override
        public imports.k8s.ObjectReference getRelated() {
            return this.related;
        }
        ...
        @Override
        public imports.k8s.EventSeries getSeries() {
            return this.series;
        }

        @Override
        public imports.k8s.EventSource getSource() {
            return this.source;
        }
