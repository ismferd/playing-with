...
public interface VolumeAttachmentSource extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements VolumeAttachmentSource {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.inlineVolumeSpec = this.jsiiGet("inlineVolumeSpec", imports.k8s.PersistentVolumeSpec.class);
         ...
         */
        private Jsii$Proxy(final imports.k8s.PersistentVolumeSpec inlineVolumeSpec, final java.lang.String persistentVolumeName) {
        ...
        @Override
        public imports.k8s.PersistentVolumeSpec getInlineVolumeSpec() {
