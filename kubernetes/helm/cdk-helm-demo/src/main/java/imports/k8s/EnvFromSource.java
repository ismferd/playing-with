...
public interface EnvFromSource extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements EnvFromSource {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.configMapRef = this.jsiiGet("configMapRef", imports.k8s.ConfigMapEnvSource.class);
            this.prefix = this.jsiiGet("prefix", java.lang.String.class);
            this.secretRef = this.jsiiGet("secretRef", imports.k8s.SecretEnvSource.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final imports.k8s.ConfigMapEnvSource configMapRef, final java.lang.String prefix, final imports.k8s.SecretEnvSource secretRef) {
        ...
        @Override
        public imports.k8s.ConfigMapEnvSource getConfigMapRef() {
        ...
        @Override
        public imports.k8s.SecretEnvSource getSecretRef() {
