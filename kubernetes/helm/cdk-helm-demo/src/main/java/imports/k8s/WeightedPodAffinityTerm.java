 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:09.061Z")
...
public interface WeightedPodAffinityTerm extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements WeightedPodAffinityTerm {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.podAffinityTerm = this.jsiiGet("podAffinityTerm", imports.k8s.PodAffinityTerm.class);
         ...
         */
        private Jsii$Proxy(final imports.k8s.PodAffinityTerm podAffinityTerm, final java.lang.Number weight) {
        ...
        @Override
        public imports.k8s.PodAffinityTerm getPodAffinityTerm() {
