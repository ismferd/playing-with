...
public interface CsiNodeOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CsiNodeOptions {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.spec = this.jsiiGet("spec", imports.k8s.CsiNodeSpec.class);
         ...
         */
        private Jsii$Proxy(final imports.k8s.CsiNodeSpec spec, final imports.k8s.ObjectMeta metadata) {
        ...
        @Override
        public imports.k8s.CsiNodeSpec getSpec() {
            return this.spec;
        }
