...
public interface ReplicaSetSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicaSetSpec {
         ...
         */
        private Jsii$Proxy(final imports.k8s.LabelSelector selector, final java.lang.Number minReadySeconds, final java.lang.Number replicas, final imports.k8s.PodTemplateSpec template) {
