...
public interface PodDisruptionBudgetListOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodDisruptionBudgetListOptions {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.items = this.jsiiGet("items", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.PodDisruptionBudget.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final java.util.List<? extends imports.k8s.PodDisruptionBudget> items, final imports.k8s.ListMeta metadata) {
        ...
        @Override
        public java.util.List<imports.k8s.PodDisruptionBudget> getItems() {
            return this.items;
        }
