...
public interface VolumeNodeAffinity extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements VolumeNodeAffinity {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.required = this.jsiiGet("required", imports.k8s.NodeSelector.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final imports.k8s.NodeSelector required) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.required = required;
        }

        @Override
        public imports.k8s.NodeSelector getRequired() {
