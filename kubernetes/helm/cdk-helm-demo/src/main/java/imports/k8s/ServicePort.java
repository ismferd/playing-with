...
public interface ServicePort extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ServicePort {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.targetPort = this.jsiiGet("targetPort", imports.k8s.IntOrString.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final java.lang.Number port, final java.lang.String name, final java.lang.Number nodePort, final java.lang.String protocol, final imports.k8s.IntOrString targetPort) {
        ...
        @Override
        public imports.k8s.IntOrString getTargetPort() {
