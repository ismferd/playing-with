 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:09.036Z")
...
public interface StatefulSetSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetSpec {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.updateStrategy = this.jsiiGet("updateStrategy", imports.k8s.StatefulSetUpdateStrategy.class);
            this.volumeClaimTemplates = this.jsiiGet("volumeClaimTemplates", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.PersistentVolumeClaim.class)));
        }
        ...
        @Override
        public imports.k8s.StatefulSetUpdateStrategy getUpdateStrategy() {
            return this.updateStrategy;
        }

        @Override
        public java.util.List<imports.k8s.PersistentVolumeClaim> getVolumeClaimTemplates() {
