 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.891Z")
...
public interface EnvVarSource extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements EnvVarSource {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.configMapKeyRef = this.jsiiGet("configMapKeyRef", imports.k8s.ConfigMapKeySelector.class);
            this.fieldRef = this.jsiiGet("fieldRef", imports.k8s.ObjectFieldSelector.class);
            this.resourceFieldRef = this.jsiiGet("resourceFieldRef", imports.k8s.ResourceFieldSelector.class);
            this.secretKeyRef = this.jsiiGet("secretKeyRef", imports.k8s.SecretKeySelector.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final imports.k8s.ConfigMapKeySelector configMapKeyRef, final imports.k8s.ObjectFieldSelector fieldRef, final imports.k8s.ResourceFieldSelector resourceFieldRef, final imports.k8s.SecretKeySelector secretKeyRef) {
        ...
        @Override
        public imports.k8s.ConfigMapKeySelector getConfigMapKeyRef() {
            return this.configMapKeyRef;
        }

        @Override
        public imports.k8s.ObjectFieldSelector getFieldRef() {
            return this.fieldRef;
        }

        @Override
        public imports.k8s.ResourceFieldSelector getResourceFieldRef() {
            return this.resourceFieldRef;
        }

        @Override
        public imports.k8s.SecretKeySelector getSecretKeyRef() {
