...
public interface SelfSubjectAccessReviewOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SelfSubjectAccessReviewOptions {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.spec = this.jsiiGet("spec", imports.k8s.SelfSubjectAccessReviewSpec.class);
         ...
         */
        private Jsii$Proxy(final imports.k8s.SelfSubjectAccessReviewSpec spec, final imports.k8s.ObjectMeta metadata) {
        ...
        @Override
        public imports.k8s.SelfSubjectAccessReviewSpec getSpec() {
            return this.spec;
        }
