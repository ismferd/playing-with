...
public interface ResourceQuotaSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ResourceQuotaSpec {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.hard = this.jsiiGet("hard", software.amazon.jsii.NativeType.mapOf(software.amazon.jsii.NativeType.forClass(imports.k8s.Quantity.class)));
            ...
            this.scopeSelector = this.jsiiGet("scopeSelector", imports.k8s.ScopeSelector.class);
        }
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final java.util.Map<java.lang.String, ? extends imports.k8s.Quantity> hard, final java.util.List<java.lang.String> scopes, final imports.k8s.ScopeSelector scopeSelector) {
        ...
        @Override
        public java.util.Map<java.lang.String, imports.k8s.Quantity> getHard() {
            return this.hard;
        }
        ...
        @Override
        public imports.k8s.ScopeSelector getScopeSelector() {
