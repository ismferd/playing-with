...
public interface TokenReviewOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements TokenReviewOptions {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.spec = this.jsiiGet("spec", imports.k8s.TokenReviewSpec.class);
         ...
         */
        private Jsii$Proxy(final imports.k8s.TokenReviewSpec spec, final imports.k8s.ObjectMeta metadata) {
        ...
        @Override
        public imports.k8s.TokenReviewSpec getSpec() {
            return this.spec;
        }
