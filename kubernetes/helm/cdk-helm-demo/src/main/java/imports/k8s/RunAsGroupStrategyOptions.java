 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:09.011Z")
...
public interface RunAsGroupStrategyOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements RunAsGroupStrategyOptions {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.ranges = this.jsiiGet("ranges", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.IdRange.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final java.lang.String rule, final java.util.List<? extends imports.k8s.IdRange> ranges) {
        ...
        @Override
        public java.util.List<imports.k8s.IdRange> getRanges() {
            return this.ranges;
        }
