 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.977Z")
...
public interface PodSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSpec {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.containers = this.jsiiGet("containers", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.Container.class)));
            this.activeDeadlineSeconds = this.jsiiGet("activeDeadlineSeconds", java.lang.Number.class);
            this.affinity = this.jsiiGet("affinity", imports.k8s.Affinity.class);
            this.automountServiceAccountToken = this.jsiiGet("automountServiceAccountToken", java.lang.Boolean.class);
            this.dnsConfig = this.jsiiGet("dnsConfig", imports.k8s.PodDnsConfig.class);
            ...
            this.hostAliases = this.jsiiGet("hostAliases", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.HostAlias.class)));
            ...
            this.imagePullSecrets = this.jsiiGet("imagePullSecrets", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.LocalObjectReference.class)));
            this.initContainers = this.jsiiGet("initContainers", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.Container.class)));
            ...
            this.readinessGates = this.jsiiGet("readinessGates", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.PodReadinessGate.class)));
            ...
            this.securityContext = this.jsiiGet("securityContext", imports.k8s.PodSecurityContext.class);
            ...
            this.tolerations = this.jsiiGet("tolerations", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.Toleration.class)));
            this.volumes = this.jsiiGet("volumes", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.Volume.class)));
        }
        ...
        @Override
        public java.util.List<imports.k8s.Container> getContainers() {
        ...
        @Override
        public imports.k8s.Affinity getAffinity() {
        ...
        @Override
        public imports.k8s.PodDnsConfig getDnsConfig() {
        ...
        @Override
        public java.util.List<imports.k8s.HostAlias> getHostAliases() {
        ...
        @Override
        public java.util.List<imports.k8s.LocalObjectReference> getImagePullSecrets() {
            return this.imagePullSecrets;
        }

        @Override
        public java.util.List<imports.k8s.Container> getInitContainers() {
        ...
        @Override
        public java.util.List<imports.k8s.PodReadinessGate> getReadinessGates() {
        ...
        @Override
        public imports.k8s.PodSecurityContext getSecurityContext() {
        ...
        @Override
        public java.util.List<imports.k8s.Toleration> getTolerations() {
            return this.tolerations;
        }

        @Override
        public java.util.List<imports.k8s.Volume> getVolumes() {
            return this.volumes;
        }
