...
public interface StatusOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatusOptions {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.details = this.jsiiGet("details", imports.k8s.StatusDetails.class);
         ...
         */
        private Jsii$Proxy(final java.lang.Number code, final imports.k8s.StatusDetails details, final java.lang.String message, final imports.k8s.ListMeta metadata, final java.lang.String reason) {
        ...
        @Override
        public imports.k8s.StatusDetails getDetails() {
            return this.details;
        }
