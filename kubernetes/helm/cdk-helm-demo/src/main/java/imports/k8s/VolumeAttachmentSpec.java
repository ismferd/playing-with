...
public interface VolumeAttachmentSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements VolumeAttachmentSpec {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.source = this.jsiiGet("source", imports.k8s.VolumeAttachmentSource.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final java.lang.String attacher, final java.lang.String nodeName, final imports.k8s.VolumeAttachmentSource source) {
        ...
        @Override
        public imports.k8s.VolumeAttachmentSource getSource() {
            return this.source;
        }
