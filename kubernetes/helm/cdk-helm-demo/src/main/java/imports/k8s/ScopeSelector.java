...
public interface ScopeSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ScopeSelector {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.matchExpressions = this.jsiiGet("matchExpressions", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.ScopedResourceSelectorRequirement.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final java.util.List<? extends imports.k8s.ScopedResourceSelectorRequirement> matchExpressions) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.matchExpressions = (java.util.List<imports.k8s.ScopedResourceSelectorRequirement>)matchExpressions;
        }

        @Override
        public java.util.List<imports.k8s.ScopedResourceSelectorRequirement> getMatchExpressions() {
