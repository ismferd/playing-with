 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.905Z")
...
public interface HttpGetAction extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements HttpGetAction {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.httpHeaders = this.jsiiGet("httpHeaders", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.HttpHeader.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final imports.k8s.IntOrString port, final java.lang.String host, final java.util.List<? extends imports.k8s.HttpHeader> httpHeaders, final java.lang.String path, final java.lang.String scheme) {
        ...
        @Override
        public java.util.List<imports.k8s.HttpHeader> getHttpHeaders() {
