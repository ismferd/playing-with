...
public interface StatefulSetUpdateStrategy extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetUpdateStrategy {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.rollingUpdate = this.jsiiGet("rollingUpdate", imports.k8s.RollingUpdateStatefulSetStrategy.class);
         ...
         */
        private Jsii$Proxy(final imports.k8s.RollingUpdateStatefulSetStrategy rollingUpdate, final java.lang.String type) {
        ...
        @Override
        public imports.k8s.RollingUpdateStatefulSetStrategy getRollingUpdate() {
