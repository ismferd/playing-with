 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.815Z")
...
public interface Affinity extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements Affinity {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.nodeAffinity = this.jsiiGet("nodeAffinity", imports.k8s.NodeAffinity.class);
            this.podAffinity = this.jsiiGet("podAffinity", imports.k8s.PodAffinity.class);
            this.podAntiAffinity = this.jsiiGet("podAntiAffinity", imports.k8s.PodAntiAffinity.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final imports.k8s.NodeAffinity nodeAffinity, final imports.k8s.PodAffinity podAffinity, final imports.k8s.PodAntiAffinity podAntiAffinity) {
        ...
        @Override
        public imports.k8s.NodeAffinity getNodeAffinity() {
            return this.nodeAffinity;
        }

        @Override
        public imports.k8s.PodAffinity getPodAffinity() {
            return this.podAffinity;
        }

        @Override
        public imports.k8s.PodAntiAffinity getPodAntiAffinity() {
