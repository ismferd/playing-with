...
public interface IngressRule extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements IngressRule {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.http = this.jsiiGet("http", imports.k8s.HttpIngressRuleValue.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final java.lang.String host, final imports.k8s.HttpIngressRuleValue http) {
        ...
        @Override
        public imports.k8s.HttpIngressRuleValue getHttp() {
            return this.http;
        }
