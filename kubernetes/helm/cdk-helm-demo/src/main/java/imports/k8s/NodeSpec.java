...
public interface NodeSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NodeSpec {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.configSource = this.jsiiGet("configSource", imports.k8s.NodeConfigSource.class);
            ...
            this.taints = this.jsiiGet("taints", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.Taint.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final imports.k8s.NodeConfigSource configSource, final java.lang.String externalId, final java.lang.String podCidr, final java.lang.String providerId, final java.util.List<? extends imports.k8s.Taint> taints, final java.lang.Boolean unschedulable) {
        ...
        @Override
        public imports.k8s.NodeConfigSource getConfigSource() {
        ...
        @Override
        public java.util.List<imports.k8s.Taint> getTaints() {
            return this.taints;
        }
