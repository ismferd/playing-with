 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.830Z")
...
public interface AuditSinkSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements AuditSinkSpec {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.policy = this.jsiiGet("policy", imports.k8s.Policy.class);
            this.webhook = this.jsiiGet("webhook", imports.k8s.Webhook.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final imports.k8s.Policy policy, final imports.k8s.Webhook webhook) {
        ...
        @Override
        public imports.k8s.Policy getPolicy() {
            return this.policy;
        }

        @Override
        public imports.k8s.Webhook getWebhook() {
            return this.webhook;
        }
