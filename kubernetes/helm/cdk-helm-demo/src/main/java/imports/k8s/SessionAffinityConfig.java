 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:09.034Z")
...
public interface SessionAffinityConfig extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SessionAffinityConfig {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.clientIp = this.jsiiGet("clientIP", imports.k8s.ClientIpConfig.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final imports.k8s.ClientIpConfig clientIp) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.clientIp = clientIp;
        }

        @Override
        public imports.k8s.ClientIpConfig getClientIp() {
