 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.951Z")
...
public interface NodeSelectorTerm extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NodeSelectorTerm {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.matchExpressions = this.jsiiGet("matchExpressions", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.NodeSelectorRequirement.class)));
            this.matchFields = this.jsiiGet("matchFields", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.NodeSelectorRequirement.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final java.util.List<? extends imports.k8s.NodeSelectorRequirement> matchExpressions, final java.util.List<? extends imports.k8s.NodeSelectorRequirement> matchFields) {
        ...
        @Override
        public java.util.List<imports.k8s.NodeSelectorRequirement> getMatchExpressions() {
            return this.matchExpressions;
        }

        @Override
        public java.util.List<imports.k8s.NodeSelectorRequirement> getMatchFields() {
