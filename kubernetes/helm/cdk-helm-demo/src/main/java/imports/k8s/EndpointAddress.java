 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.887Z")
...
public interface EndpointAddress extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements EndpointAddress {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.targetRef = this.jsiiGet("targetRef", imports.k8s.ObjectReference.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final java.lang.String ip, final java.lang.String hostname, final java.lang.String nodeName, final imports.k8s.ObjectReference targetRef) {
        ...
        @Override
        public imports.k8s.ObjectReference getTargetRef() {
