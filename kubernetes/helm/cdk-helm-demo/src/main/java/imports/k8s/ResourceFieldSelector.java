 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:09.002Z")
...
public interface ResourceFieldSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ResourceFieldSelector {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.divisor = this.jsiiGet("divisor", imports.k8s.Quantity.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final java.lang.String resource, final java.lang.String containerName, final imports.k8s.Quantity divisor) {
        ...
        @Override
        public imports.k8s.Quantity getDivisor() {
            return this.divisor;
        }
