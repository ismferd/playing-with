 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:09.010Z")
...
public interface RollingUpdateDeployment extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements RollingUpdateDeployment {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.maxSurge = this.jsiiGet("maxSurge", imports.k8s.IntOrString.class);
         ...
         */
        private Jsii$Proxy(final imports.k8s.IntOrString maxSurge, final imports.k8s.IntOrString maxUnavailable) {
        ...
        @Override
        public imports.k8s.IntOrString getMaxSurge() {
