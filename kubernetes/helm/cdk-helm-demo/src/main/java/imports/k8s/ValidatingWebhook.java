 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:09.047Z")
...
public interface ValidatingWebhook extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ValidatingWebhook {
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final imports.k8s.WebhookClientConfig clientConfig, final java.lang.String name, final java.util.List<java.lang.String> admissionReviewVersions, final java.lang.String failurePolicy, final java.lang.String matchPolicy, final imports.k8s.LabelSelector namespaceSelector, final imports.k8s.LabelSelector objectSelector, final java.util.List<? extends imports.k8s.RuleWithOperations> rules, final java.lang.String sideEffects, final java.lang.Number timeoutSeconds) {
