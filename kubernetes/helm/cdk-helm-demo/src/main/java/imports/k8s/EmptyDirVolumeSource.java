...
public interface EmptyDirVolumeSource extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements EmptyDirVolumeSource {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.sizeLimit = this.jsiiGet("sizeLimit", imports.k8s.Quantity.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final java.lang.String medium, final imports.k8s.Quantity sizeLimit) {
        ...
        @Override
        public imports.k8s.Quantity getSizeLimit() {
