...
public interface Lifecycle extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements Lifecycle {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.postStart = this.jsiiGet("postStart", imports.k8s.Handler.class);
            this.preStop = this.jsiiGet("preStop", imports.k8s.Handler.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final imports.k8s.Handler postStart, final imports.k8s.Handler preStop) {
        ...
        @Override
        public imports.k8s.Handler getPostStart() {
            return this.postStart;
        }

        @Override
        public imports.k8s.Handler getPreStop() {
            return this.preStop;
        }
