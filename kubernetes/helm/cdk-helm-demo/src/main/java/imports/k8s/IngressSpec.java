 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.912Z")
...
public interface IngressSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements IngressSpec {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.rules = this.jsiiGet("rules", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.IngressRule.class)));
            this.tls = this.jsiiGet("tls", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.IngressTls.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final imports.k8s.IngressBackend backend, final java.util.List<? extends imports.k8s.IngressRule> rules, final java.util.List<? extends imports.k8s.IngressTls> tls) {
        ...
        @Override
        public java.util.List<imports.k8s.IngressRule> getRules() {
            return this.rules;
        }

        @Override
        public java.util.List<imports.k8s.IngressTls> getTls() {
            return this.tls;
        }
