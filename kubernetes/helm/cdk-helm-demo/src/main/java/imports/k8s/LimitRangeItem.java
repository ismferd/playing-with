...
public interface LimitRangeItem extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements LimitRangeItem {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.defaultValue = this.jsiiGet("default", software.amazon.jsii.NativeType.mapOf(software.amazon.jsii.NativeType.forClass(imports.k8s.Quantity.class)));
            this.defaultRequest = this.jsiiGet("defaultRequest", software.amazon.jsii.NativeType.mapOf(software.amazon.jsii.NativeType.forClass(imports.k8s.Quantity.class)));
            this.max = this.jsiiGet("max", software.amazon.jsii.NativeType.mapOf(software.amazon.jsii.NativeType.forClass(imports.k8s.Quantity.class)));
            this.maxLimitRequestRatio = this.jsiiGet("maxLimitRequestRatio", software.amazon.jsii.NativeType.mapOf(software.amazon.jsii.NativeType.forClass(imports.k8s.Quantity.class)));
            this.min = this.jsiiGet("min", software.amazon.jsii.NativeType.mapOf(software.amazon.jsii.NativeType.forClass(imports.k8s.Quantity.class)));
        ...
        @Override
        public java.util.Map<java.lang.String, imports.k8s.Quantity> getDefaultValue() {
            return this.defaultValue;
        }

        @Override
        public java.util.Map<java.lang.String, imports.k8s.Quantity> getDefaultRequest() {
            return this.defaultRequest;
        }

        @Override
        public java.util.Map<java.lang.String, imports.k8s.Quantity> getMax() {
            return this.max;
        }

        @Override
        public java.util.Map<java.lang.String, imports.k8s.Quantity> getMaxLimitRequestRatio() {
            return this.maxLimitRequestRatio;
        }

        @Override
        public java.util.Map<java.lang.String, imports.k8s.Quantity> getMin() {
            return this.min;
        }
