...
public interface ComponentStatusOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ComponentStatusOptions {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.conditions = this.jsiiGet("conditions", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.ComponentCondition.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final java.util.List<? extends imports.k8s.ComponentCondition> conditions, final imports.k8s.ObjectMeta metadata) {
        ...
        @Override
        public java.util.List<imports.k8s.ComponentCondition> getConditions() {
