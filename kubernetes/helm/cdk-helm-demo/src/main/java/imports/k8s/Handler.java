 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.902Z")
...
public interface Handler extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements Handler {
         ...
         */
        private Jsii$Proxy(final imports.k8s.ExecAction exec, final imports.k8s.HttpGetAction httpGet, final imports.k8s.TcpSocketAction tcpSocket) {
