 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:08.880Z")
...
public interface DaemonSetSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonSetSpec {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.updateStrategy = this.jsiiGet("updateStrategy", imports.k8s.DaemonSetUpdateStrategy.class);
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        private Jsii$Proxy(final imports.k8s.LabelSelector selector, final imports.k8s.PodTemplateSpec template, final java.lang.Number minReadySeconds, final java.lang.Number revisionHistoryLimit, final imports.k8s.DaemonSetUpdateStrategy updateStrategy) {
        ...
        @Override
        public imports.k8s.DaemonSetUpdateStrategy getUpdateStrategy() {
