 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.13.0 (build 385c325)", date = "2020-11-08T11:11:09.037Z")
...
public interface StatusDetails extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatusDetails {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.causes = this.jsiiGet("causes", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.StatusCause.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        private Jsii$Proxy(final java.util.List<? extends imports.k8s.StatusCause> causes, final java.lang.String group, final java.lang.String kind, final java.lang.String name, final java.lang.Number retryAfterSeconds, final java.lang.String uid) {
        ...
        @Override
        public java.util.List<imports.k8s.StatusCause> getCauses() {
            return this.causes;
        }
